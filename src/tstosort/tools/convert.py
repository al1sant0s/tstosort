...
SCORPIO_PREFIX_TYPES = {"building": "bld_", "character": "cha_", "characterskin": "cha_", "buildingskin": "bld_"}
            ...
            if pattern.match(scorpio_file.name):
                ...
                with open(scorpio_file, "rb") as f:
                    ...
                    for group in root.findall("group"):
                        ...
                        if group.attrib.get("prefix", "") == prefix:
                            for item in group.findall("item"):
                                if item.attrib.get("suffix", "") == suffix:
                                    return item.text
                    ...
                    if int(element.attrib.get("id", -1)) == id:
                        ...
                        if textpoolname is not None:
                            ...
                            if prefix in SCORPIO_INDEX_PREFIX:
                                suffix = textpoolname.strip(prefix)
                            ...
                            prefix = SCORPIO_PREFIX_TYPES.get(obj_type, SCORPIO_PREFIX_TYPES.get(element.attrib.get("type", "").lower(), ""))
                            suffix = name + "_name"
...
def sort_menu(storemenu, languages, indent):
...
def main():
    ...
    for i in range(len(directories)):
        ...
        sort_menu(storemenu, args.language, args.indent)
        ...
        if args.inventory is True:
            ...
            sort_menu(inventory, args.language, args.indent)
