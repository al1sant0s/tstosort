...
This tool allows you to create storemenu files sorted in alphabetical order according to each language
...
The textpools folders need to named in the format "textpools-*" where * stands for one of languages codes used by the game.

The files generated will have the prefix "autogenerated_*" where * stands for one of languages codes used by the game.
